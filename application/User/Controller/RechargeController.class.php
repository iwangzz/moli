    ...
    public function recharge() {
        ...
        if (IS_POST) {
            ...
            if ($rechargeinfo) {
                ...
                $back_url = $_SERVER['SERVER_NAME'] . '/index.php/user/recharge/rechargeBack';
                $Priv1 = 'Memo';
                $GateId = '';
                $money = $money * 100;
                ...
                $plain = $merid . $order_number . $money . $this->CuryId . $transdate . $this->transtype . $this->Version . $back_url . $back_url . $GateId . $Priv1;
                $key_sign = sign($plain);
