...
function change_images(uploadid, returnid) {
    ...
    $.each(contents, function(i, n) {
        ...
        if(returnid != 'house_photos'){
            str += "<li id='image" + ids + "'><input title='双击查看' type='text' name='" + returnid + "_url[]' value='" + n + "' style='width:310px;' ondblclick='image_priview(this.value);' class='input image-url-input'> \n\
                <input type='hidden' value='image" + ids + "' name='imageid'>\n\
                <input type='text' name='" + returnid + "_alt[]' value='" + filename + "' style='width:160px;' class='input image-alt-input' onfocus=\"if(this.value == this.defaultValue) this.value = ''\" onblur=\"if(this.value.replace(' ','') == '') this.value = this.defaultValue;\"> \n\
                <a href=\"javascript:flashupload('replace_albums_images', '图片替换','image" + ids + "',replace_image,'10,gif|jpg|jpeg|png|bmp,0','','','')\">替换</a>  <a href=\"javascript:remove_div('image" + ids + "')\">移除</a> </li>";
        }else{
            str += "<li id='image" + ids + "'><input type='hidden' value='image" + ids + "' name='houseimageid'>\n\
<input title='双击查看' type='text' name='" + returnid + "_url[]' value='" + n + "' style='width:310px;' ondblclick='image_priview(this.value);' class='input image-url-input'>\n\
               <select type='text' name='" + returnid + "_alt[]'  style='width:160px;' class='select'>\n\
               <option value＝\"房产证\">房产证</option>\n\
               <option value＝\"房屋产权公证书\">房屋产权公证书</option>\n\
               <option value＝\"地产登记证明\">地产登记证明</option>\n\
               <option value＝\"房地产抵押借款合同\">房地产抵押借款合同</option>\n\
