...
<div class="main clearfix">
    ...
    <div class="main-right">
        <div class="navright clearfix">
            ...
            <a href="<?php echo ($href); ?>" class="navus current">网站公告</a>
        </div>
        <div class="jk_list_right">
            <div class="list_right_title">网站公告</div>
            <div class="us_r_bor2">
                <div class="notice_list">
                    <ul>
                        <?php if(is_array($posts_list)): foreach($posts_list as $key=>$vo): ?><li><span style="float:left"><a title="<?php echo ($vo["post_title"]); ?>" href="/index.php/portal/index/gonggaodetail/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["post_title"]); ?></a></span><span><?php echo ($vo["post_date"]); ?></span>
                            </li><?php endforeach; endif; ?>
                    </ul>
                </div>
            </div>
