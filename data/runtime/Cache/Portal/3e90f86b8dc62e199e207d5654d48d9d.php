...
<div class="main clearfix">
    ...
    <div class="main-right">
        <div class="navright clearfix">
            ...
            <a href="<?php echo ($href); ?>" class="navus current">合作伙伴</a>
        </div>
        <div class="partners">
            <img class="line" src="/themes/simplebootx/Public/images/line.png"/>

            <h2 class="part-hb">
                <img class="trans1" src="/themes/simplebootx/Public/images/show1.png"/>
                <span>合作伙伴</span>
            </h2>

            <h2 class="part-bk">
                <img src="/themes/simplebootx/Public/images/banks1.png"/>
                <img class="distance" src="/themes/simplebootx/Public/images/banks2.png"/>
                <img src="/themes/simplebootx/Public/images/banks3.png"/>
            </h2>

            <h2 class="part-bk">
                <img src="/themes/simplebootx/Public/images/banks4.png"/>
                <img class="distance" src="/themes/simplebootx/Public/images/banks5.png"/>
                <img src="/themes/simplebootx/Public/images/banks6.png"/>
            </h2>

            <h2 class="part-bk">
                <img src="/themes/simplebootx/Public/images/banks7.png"/>
                <img class="distance" src="/themes/simplebootx/Public/images/banks8.png"/>
                <img src="/themes/simplebootx/Public/images/banks9.png"/>
            </h2>

            <h2 class="part-bk">
                <img src="/themes/simplebootx/Public/images/banks10.png"/>
                <img class="distance" src="/themes/simplebootx/Public/images/banks11.png"/>
                <img src="/themes/simplebootx/Public/images/banks12.png"/>
            </h2>

            <h2 class="part-bk">
                <img src="/themes/simplebootx/Public/images/banks13.png"/>
                <img class="distance" src="/themes/simplebootx/Public/images/banks14.png"/>
