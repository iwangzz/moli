...
<div class="main clearfix">
    ...
    <div class="main-right">
        <div class="navright clearfix">
            ...
            <a href="<?php echo ($href); ?>" class="navus current">常见问题</a>
        </div>
        <div class="problems clearfix">
            <img class="line" src="/themes/simplebootx/Public/images/line.png"/>

            <h2 class="btn1">
                <img class="trans1" src="/themes/simplebootx/Public/images/show2.png"/>
                <span>提现什么时候到账？</span>
            </h2>

            <div class="explain">
                <span class="pall">所有项目在购买成功后均不可撤销，债权转让项目持有1个月以后可以申请债权转让，转让成功即可收回资金。</span>
...
<script>
    $('.btn1').click(function () {
        if ($(this).find('img').attr('src') == '/themes/simplebootx/Public/images/show1.png') {
            $(this).find('img').attr('src', '/themes/simplebootx/Public/images/show2.png');
        } else {
            $(this).find('img').attr('src', '/themes/simplebootx/Public/images/show1.png');
        }
        $('.explain').eq(($(this).index() - 1) / 2).slideToggle(500);
    });
</script>
