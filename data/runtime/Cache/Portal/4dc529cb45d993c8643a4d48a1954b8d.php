...
<div class="main clearfix">
    ...
    <div class="main-right">
        ...
        <!--公告详情-->
        <div class="jk_list_right" style="padding-left:0px;padding-top:0px">
            <div class="title_bor"><!--<h1>网站公告</h1>--></div>
            <div class="content_h3" align="center"><?php echo ($list["post_title"]); ?></div>
            <br>

            <div align="center" class="content_div"> 发布人：摩利官方 &nbsp;&nbsp; 发布时间：<?php echo ($list["post_date"]); ?> &nbsp;&nbsp; </div>
            <br>

            <div class="us_r_bor2">
                <div class="content ggcontent">
