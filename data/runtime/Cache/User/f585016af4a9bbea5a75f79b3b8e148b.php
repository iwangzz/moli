        ...
        <div class="user-info-box fn-clear">
            ...
            <div class="user-security-container mt5 mb5">
                ...
                <div class="user-security-box fn-clear">
                    <?php if(($user_info["id_number"] != '') and ($user_info["user_trade_pass"] != '')): ?><span class="user-security-level">安全等级 <label id="sec-level">高</label></span>
                        <?php elseif(($user_info["id_number"] != '') or ($user_info["user_trade_pass"] != '')): ?>
                        <span class="user-security-level">安全等级 <label id="sec-level">中</label></span>
                        <?php else: ?>
                        <span class="user-security-level">安全等级 <label id="sec-level">低</label></span><?php endif; ?>
                    <a class="safe-rank cellphone light" href="/index.php/user/index/accountinfo"></a>
                    <a class="safe-rank man 
                       <?php if( $user_info["id_number"] != ''): ?>light<?php endif; ?>
                    " href="/index.php/user/index/realname" ></a>
                    <a class="safe-rank lock 
                       <?php if( $user_info["user_trade_pass"] != ''): ?>light<?php endif; ?>
