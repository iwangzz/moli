                                ...
                                <ul class="info-list fn-clear">
                                            ...
                                            <?php if($userinfo["user_nicename"] == ''): ?><span class="info-value">
                                                ...
                                                <span class="info-value">
                                                    <input type="text" name="usernicename" value="<?php echo ($userinfo["user_nicename"]); ?>"
                                                           class="not-set-status" disabled="disabled"/>
                                                    <span class="modify-wrap">
                                                        <a target="_blank" href="javascript:void(0);"
                                    ...
                                    <li class="info-item info-item-col-2">
                                        ...
                                        <?php if($userinfo["user_trade_pass"] == ''): ?><span class="info-value">
                                            ...
                                            <?php else: ?>
                                            <span class="info-value">
                                                    <span class="not-set-status">已设置</span>
                                                    <span class="modify-wrap">
                                                        <a target="_blank"
...
<script>
    $(document).ready(function () {
        $(document).on("click",'.changenicename',function () {
            $(this).empty().html("保存");
            $(this).parents('.info-value').find('.not-set-status').removeAttr('disabled');
            $(this).parents('.info-value').find('.not-set-status').css({
...
//                    alert(data.msg)
                    ...
                    $(this).parents('.info-value').find('.not-set-status').attr('disabled', 'disabled');
                    $(this).parents('.info-value').find('.not-set-status').css({
                        'color': 'red',
                        'border': 'none',
                        'background': 'none'
